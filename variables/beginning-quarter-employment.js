class BeginningQuarterEmploymentPage {
    constructor() {
        this.init();
    }
...
document.addEventListener('DOMContentLoaded', () => {
    const beginningQuarterEmploymentPage = new BeginningQuarterEmploymentPage();

    document.addEventListener('keydown', (e) => {
        if (e.key === 'Escape') {
            beginningQuarterEmploymentPage.resetCardStates();
        }
    });
});
